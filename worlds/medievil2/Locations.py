...
location_tables = {
    ...
    # Boss Fight
    "Tyrannosaurus Wrecks": [
        Medievil2LocationData("Life Bottle: Tyrannosaurus Wrecks - TW", "Ammo: Gold Shield (100)", Medievil2LocationCategory.LIFE_BOTTLE),
    ...
    "Kensington": [
        Medievil2LocationData("Key Item: The Depot Key", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Town House Key", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Pocketwatch", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Equipment: Gold Shield on Railway - KT", "Ammo: Gold Shield (100)", Medievil2LocationCategory.WEAPON),
    ...
    "The Tomb": [
        Medievil2LocationData("Key Item: Scroll of Sekhmet", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Tablet of Horus", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Staff of Anubis", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        ...
        Medievil2LocationData("Gold Coins: Chest Ground Floor - TT", "Ammo: Gold Shield (100)", Medievil2LocationCategory.GOLD),
        Medievil2LocationData("Gold Coins: Chest Upper Floor - TT", "Ammo: Gold Shield (100)", Medievil2LocationCategory.GOLD),
    ...
    "Kew Gardens": [
        Medievil2LocationData("Key Item: Potting Shed Key", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        ...
        Medievil2LocationData("Key Item: Hot House Valve - KG", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Life Bottle: Kew Gardens - KG", "Ammo: Gold Shield (100)", Medievil2LocationCategory.LIFE_BOTTLE),
        ...
        Medievil2LocationData("Winson - Infection - KG", "Ammo: Gold Shield (100)", Medievil2LocationCategory.WINSTON),
    ...
    "Whitechapel": [
        Medievil2LocationData("Key Items: Library Key in House Basement - WC", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Items: Griffin Shield - WC", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Membership Card - WC", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Elegant Suite - WC", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
    ...
    "The Sewers": [
        ...
        Medievil2LocationData("Girls Freed - 1 - TS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.EVENT),
        Medievil2LocationData("Girls Freed - 2 - TS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.EVENT),
        Medievil2LocationData("Girls Freed - 3 - TS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.EVENT),
        Medievil2LocationData("Girls Freed - 4 - TS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.EVENT),
        Medievil2LocationData("Girls Freed - 5 - TS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.EVENT),
    ...
    "Cathedral Spires": [
        Medievil2LocationData("Key Item: Lost Soul 1 - Bottom left of Cathedral - CS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Lost Soul 2 - Top of Cathedral - CS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Lost Soul 3 - Left Chapel on the Roo - CS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Lost Soul 4 - Right Chapel on the Roo - CS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
        Medievil2LocationData("Key Item: Lost Soul 5 - Next to Life Bottle - CS", "Ammo: Gold Shield (100)", Medievil2LocationCategory.KEY_ITEM),
