...
def set_keyitemsanity_progression(self):
    ...
    set_rule(
        ...
        lambda state: has_keyitems_required(self, ["Museum Key", "Dinosaur Key", "Cannon Ball", "Torch"], state)
        and is_level_cleared(self, "The Museum", state),
    )
    set_rule(self.get_entrance("Tyrannosaurus Wrecks -> Hub"), lambda state: is_level_cleared(self, "Tyrannosaurus Wrecks", state))
    set_rule(
        self.get_entrance("Hub -> The Museum"),
        lambda state: is_level_cleared(self, "The Museum", state)
        and has_keyitems_required(self, ["Museum Key", "Dinosaur Key", "Cannon Ball", "Torch"], state),
    )
    set_rule(
    ...
    set_rule(
        ...
        lambda state: is_level_cleared(self, "Kensington", state)
        and has_keyitems_required(self, ["Depot Key", "Town House Key", "Pocket Watch"], state),
    )
    set_rule(
    ...
    set_rule(
        ...
        lambda state: is_level_cleared(self, "Naval Academy", state)
        and has_keyitems_required(self, ["Pond Room Valve", "Potting Shed Key", "Hothouse Valve", "Water Tank Valve"], state),
    )
    set_rule(self.get_entrance("Hub -> Dankenstein"), lambda state: is_level_cleared(self, "Kew Gardens", state))
    set_rule(self.get_entrance("Dankenstein -> Iron Slugger"), lambda state: is_level_cleared(self, "Dankenstein", state))
    set_rule(self.get_entrance("Hub -> Iron Slugger"), lambda state: is_level_cleared(self, "Dankenstein", state))
    ...
    set_rule(
        ...
        lambda state: is_level_cleared(self, "The Count", state)
    ...
    set_rule(
        ...
        lambda state: is_level_cleared(self, "The Sewers", state)
    ...
    set_rule(
        ...
        lambda state: is_level_cleared(self, "The Time Machine, The Sewers", state)
    ...
    set_rule(
        ...
        lambda state: is_level_cleared(self, "Cathedral Spires", state)
...
def set_item_rules(self):
    ...
    set_key_blocks(self, ["Key Item: Pond Room Valve - KG"], ["Potting Shed Key", "Water Tank Valve"])

    set_key_blocks(self, ["Key Item: Hothouse Valve - KG", "Cleared: Kew Gardens"], ["Potting Shed Key", "Water Tank Valve", "Pond Room Valve"])
    ...
    set_key_blocks(
        ...
        ["Potting Shed Key", "Water Tank Valve", "Pond Room Valve", "Hothouse Valve"],
    )
