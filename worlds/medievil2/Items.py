...
_all_items: List[Medievil2ItemData] = [
    ...
    Medievil2ItemData("Ammo: Dan's Armour (50)", 26, Medievil2ItemCategory.WEAPON_AMMO, False),
    Medievil2ItemData("Ammo: Dan's Armour (100)", 27, Medievil2ItemCategory.WEAPON_AMMO, False),
    # Charge
    Medievil2ItemData("Charge: Lightning (30)", 28, Medievil2ItemCategory.WEAPON_CHARGE, False),
    Medievil2ItemData("Charge: Lightning (50)", 29, Medievil2ItemCategory.WEAPON_CHARGE, False),
    Medievil2ItemData("Charge: Broadsword (30)", 30, Medievil2ItemCategory.WEAPON_CHARGE, False),
    Medievil2ItemData("Charge: Broadsword (50)", 31, Medievil2ItemCategory.WEAPON_CHARGE, False),
    # Melee Weapons
    Medievil2ItemData("Small Sword", 32, Medievil2ItemCategory.MELEE_WEAPONS, True),
    Medievil2ItemData("Broadsword", 33, Medievil2ItemCategory.MELEE_WEAPONS, True),
    Medievil2ItemData("Magic Sword", 34, Medievil2ItemCategory.MELEE_WEAPONS, True),
    Medievil2ItemData("Cane Stick", 35, Medievil2ItemCategory.MELEE_WEAPONS, True),
    Medievil2ItemData("Hammer", 36, Medievil2ItemCategory.MELEE_WEAPONS, True),
    Medievil2ItemData("Axe", 37, Medievil2ItemCategory.MELEE_WEAPONS, True),
    # Ranged Weapons
    Medievil2ItemData("Pistol", 38, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Crossbow", 39, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Flaming Crossbow", 40, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Gatling Gun", 41, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Good Lightning", 42, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Lightning", 43, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Blunderbuss", 44, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Bombs", 45, Medievil2ItemCategory.RANGED_WEAPONS, True),
    Medievil2ItemData("Chicken Drumsticks", 46, Medievil2ItemCategory.RANGED_WEAPONS, True),
    # Shields
    Medievil2ItemData("Copper Shield", 47, Medievil2ItemCategory.SHIELDS, True),
    Medievil2ItemData("Silver Shield", 48, Medievil2ItemCategory.SHIELDS, True),
    Medievil2ItemData("Gold Shield", 49, Medievil2ItemCategory.SHIELDS, True),
    # Life Bottles
    Medievil2ItemData("Life Bottle", 50, Medievil2ItemCategory.LIFE_BOTTLE, True),
    # Dans Armour
    Medievil2ItemData("Gold Armour", 51, Medievil2ItemCategory.DANS_ARMOUR, True),
    # Skills
    Medievil2ItemData("Dan Hand", 52, Medievil2ItemCategory.SKILLS, True),
    # Key Items
    Medievil2ItemData("Poster", 53, Medievil2ItemCategory.KEY_ITEMS, True),
